...
export const GOOGLE_SIGN_IN_REQUEST = `${prefix}/GOOGLE_SIGN_IN_REQUEST`
export const GOOGLE_SIGN_IN_SUCCESS = `${prefix}/GOOGLE_SIGN_IN_SUCCESS`
export const GOOGLE_SIGN_IN_ERROR = `${prefix}/GOOGLE_SIGN_IN_ERROR`
...
export const signGoogleInSaga = function * () {
    while (true) {
        ...
        try {
            ...
            yield firebase.auth().signInWithPopup(provider).then(function(result) {
